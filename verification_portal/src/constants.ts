...
export const GRANITE_LAKE_PACKAGE_ID = import.meta.env.VITE_GRANITE_LAKE_PACKAGE_ID?.trim() ?? "";
...
export const GRANITE_LAKE_REGISTRY_ID = import.meta.env.VITE_GRANITE_LAKE_REGISTRY_ID?.trim() ?? "";
